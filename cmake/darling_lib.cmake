...
FUNCTION(add_darling_library name)
	...
	if (TARGET_ARM64 AND NOT DARLING_LIB_ARM_ONLY)
		set_property(TARGET ${name} APPEND_STRING PROPERTY COMPILE_FLAGS " -arch arm64")
		set_property(TARGET ${name} APPEND_STRING PROPERTY LINK_FLAGS " -arch arm64")
	endif (TARGET_ARM64 AND NOT DARLING_LIB_ARM_ONLY)
...
FUNCTION(make_fat)
    ...
    elseif (TARGET_ARM64)
        set_property(TARGET ${ARGV} APPEND_STRING PROPERTY
			COMPILE_FLAGS " -B ${CMAKE_BINARY_DIR}/src/external/cctools-port/cctools/misc/ -arch arm64")
		set_property(TARGET ${ARGV} APPEND_STRING PROPERTY
...
function(add_darling_object_library name)
	cmake_parse_arguments(OBJECT_LIB "i386_ONLY;x86_64_ONLY;ARM_ONLY;ARM64_ONLY" "" "" ${ARGN})
	foreach(f IN LISTS ARGN)
                set(files ${files} ${f})
        endforeach(f)
	...
	if (TARGET_ARM64 AND NOT OBJECT_LIB_ARM_ONLY)
        set_property(TARGET ${name} APPEND_STRING PROPERTY COMPILE_FLAGS " -arch arm64")
	endif (TARGET_ARM64 AND NOT OBJECT_LIB_ARM_ONLY)
