...
extern "C" int IOServiceGetMatchingServices(void* port, CFDictionaryRef rules, io_device_iterator_t* iter);
...
extern "C" int IOMasterPort(void* bootstrapPort, void** masterPort);
