...
void CGImageConvertExtendedSRGBToColorspace(void);
...
void CGImagePluginSetBandProc(void);
...
void CGImageSourceGetProperties(void);
void CGImageSourceGetPropertiesAtIndex(void);
...
void CGImageWriteSessionPutBytes(void);
